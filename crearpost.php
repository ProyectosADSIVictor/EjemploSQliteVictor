                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form" id="frmpost" method="post" action="crudPost.php?action=crear">
                            <div class="form-group">
                                <label>Titulo</label>
                                <input id="titulo" name="titulo" class="form-control" placeholder="Ej. Titulo de post" required>
                                <p class="help-block">Titulo del post a crear.</p>
                            </div>

                            <div class="form-group">
                                <label>Subtitulo</label>
                                <input id="subtitulo" name="subtitulo" class="form-control" placeholder="Ej. Subtitulo del post" required>
                                <p class="help-block">Subtitulo del post a crear.</p>
                            </div>

                            <div class="form-group">
                                <label>Descripci&oacute;n</label>
                                <input id="texto" name="texto" class="form-control" placeholder="Ej. Descripcion" required>
